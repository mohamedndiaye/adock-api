...
class ImportObjectifCO2TestCase(TestCase):
    ...
    def test_labelled(self):
        ...
        out = StringIO()
        call_command('import_objectif_co2', 'adock/transporteurs/tests/objectif-co2.xlsx', stdout=out)

        out_value = out.getvalue()
        self.assertIn("Row 3: SIREN 123456404 of SIREN NOT FOUND not found.", out_value)
        self.assertIn("Row 4: SIREN 123456789 and county 404 of COUNTY NOT FOUND not found.", out_value)
