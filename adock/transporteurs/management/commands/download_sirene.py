...
class Command(BaseCommand):
    help = "Scrap files.data.gouv.fr to get the list of available files and download them."
    ...
    def handle(self, *args, **options):
        ...
        for selected_link in soup.select('tr.item.type-application.type-zip > td.colname > a')[-7:]:
